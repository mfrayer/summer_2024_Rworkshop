---
title: "Summer 2024: Introduction to R"
date : "`r Sys.Date()`"
output: 
  html_document : 
    code_folding: show
...
Before the workshop, you should have R and RStudio downloaded on your computer. You should also install the following packages: 

Required: `tidyverse` 

Optional: `knitr`, `viridis`
...
total # Comments: Total is the sum of subtotal1 and subtotal2 
...
**We skipped this question in our workshop, but I will leave the code here for you to see.**
...
ggplot(merged_data_germs, aes(prop,average_flowering_time)) + geom_point()
...
ggplot(merged_data_germs, aes(prop,average_flowering_time)) + geom_point() + geom_abline(intercept = reg$coefficients[1], slope = reg$coefficients[2]) # Plot the linear model we made
